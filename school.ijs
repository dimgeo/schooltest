...
NB.
NB. This is no calculation. The main function actually considers every sample and returns 1 or 0 based on the above probability.
NB. Every time you run the test, the results will be different, but in accordance with the probability distribution.
NB.
NB.
NB. Examples:
